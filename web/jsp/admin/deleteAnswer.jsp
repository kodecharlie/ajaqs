...
<c:set var="action">
  <c:out value="/ajaqs/servlets/admin/deleteanswer?project=${project.id}&faq=${faq.id}&question=${question.id}&answer=${answer.id}" escapeXml="false"/>
</c:set>
...
<tmplt:insert template="/jsp/admin/deleteTemplate.jsp">
  ...
  <tmplt:put name="synopsis" content="${answer.answer}" direct="true" />
