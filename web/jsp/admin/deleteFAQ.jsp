...
<c:set var="action">
  <c:out value="/ajaqs/servlets/admin/deletefaq?project=${project.id}&faq=${faq.id}" escapeXml="false"/>
</c:set>
...
<tmplt:insert template="/jsp/admin/deleteTemplate.jsp">
  ...
  <tmplt:put name="synopsis" content="${faqpath}" direct="true" />
