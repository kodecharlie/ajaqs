...
<c:set var="action">
  <c:out value="/ajaqs/servlets/admin/deletequestion?project=${project.id}&faq=${faq.id}&question=${question.id}" escapeXml="false"/>
</c:set>
...
<tmplt:insert template="/jsp/admin/deleteTemplate.jsp">
  ...
  <tmplt:put name="synopsis" content="${question.question}" direct="true" />
